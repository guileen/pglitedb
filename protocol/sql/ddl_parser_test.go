...
func TestDDLParser(t *testing.T) {
	...
	t.Run("DropTable", func(t *testing.T) {
		...
		stmt, err := ddlParser.Parse(query)
		require.NoError(t, err)
		assert.Equal(t, parser.DropTableStatement, stmt.Type)
		assert.Equal(t, "users", stmt.TableName)
	})
	...
	t.Run("AlterTable", func(t *testing.T) {
		...
		stmt, err := ddlParser.Parse(query)
		require.NoError(t, err)
		assert.Equal(t, parser.AlterTableStatement, stmt.Type)
		assert.Equal(t, "users", stmt.TableName)
	...
	t.Run("CreateIndex", func(t *testing.T) {
		...
		stmt, err := ddlParser.Parse(query)
		require.NoError(t, err)
		assert.Equal(t, parser.CreateIndexStatement, stmt.Type)
		assert.Equal(t, "users", stmt.TableName)
	...
	t.Run("DropIndex", func(t *testing.T) {
		...
		stmt, err := ddlParser.Parse(query)
		require.NoError(t, err)
		assert.Equal(t, parser.DropIndexStatement, stmt.Type)
	...
	t.Run("CreateView", func(t *testing.T) {
		...
		stmt, err := ddlParser.Parse(query)
		require.NoError(t, err)
		assert.Equal(t, parser.CreateViewStatement, stmt.Type)
	...
	t.Run("DropView", func(t *testing.T) {
		...
		stmt, err := ddlParser.Parse(query)
		require.NoError(t, err)
		assert.Equal(t, parser.DropViewStatement, stmt.Type)
