...
func BenchmarkPlanner_CreatePlan_HybridParser_SimpleSelect(b *testing.B) {
...
func BenchmarkPlanner_CreatePlan_HybridParser_ComplexSelect(b *testing.B) {
	benchprof.WithProfiling(b, func(b *testing.B) {
		parser := NewHybridPGParser()
		planner := NewPlanner(parser)
...
func BenchmarkPlanner_CreatePlan_HybridParser_Insert(b *testing.B) {
	benchprof.WithProfiling(b, func(b *testing.B) {
		parser := NewHybridPGParser()
		planner := NewPlanner(parser)
...
func BenchmarkPlanner_CreatePlan_HybridParser_Update(b *testing.B) {
	benchprof.WithProfiling(b, func(b *testing.B) {
		parser := NewHybridPGParser()
		planner := NewPlanner(parser)
...
func BenchmarkPlanner_CreatePlan_HybridParser_Delete(b *testing.B) {
	benchprof.WithProfiling(b, func(b *testing.B) {
		parser := NewHybridPGParser()
		planner := NewPlanner(parser)
