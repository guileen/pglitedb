...
func createTestSchema() *types.TableDefinition {
	return &types.TableDefinition{
		...
		Columns: []types.ColumnDefinition{
			...
			{Name: "created_at", Type: types.ColumnTypeTimestamp},
			{Name: "metadata", Type: types.ColumnTypeJSON},
			{Name: "profile_id", Type: types.ColumnTypeUUID},
		},
