...
func NewConnectionHandler(queryProcessor *QueryProcessor, statementManager *PreparedStatementManager) *ConnectionHandler {
...
func (ch *ConnectionHandler) HandleConnection(conn net.Conn) {
	...
	for {
		...
		case *pgproto3.Parse:
			...
			shouldClose = ch.statementManager.Parse(backend, msg)
		case *pgproto3.Bind:
			...
			// Delegate to statement manager
			shouldClose = ch.statementManager.Bind(backend, msg)
		case *pgproto3.Describe:
			...
			// Delegate to statement manager
			shouldClose = ch.statementManager.Describe(backend, msg)
		case *pgproto3.Execute:
			...
			// Delegate to statement manager
			shouldClose = ch.statementManager.Execute(backend, msg)
		case *pgproto3.Sync:
