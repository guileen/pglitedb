...
// ConnectionAcceptor handles connection acceptance from listeners
...
// NewConnectionAcceptor creates a new connection acceptor
func NewConnectionAcceptor() *ConnectionAcceptor {
	return &ConnectionAcceptor{}
}

// AcceptConnections handles incoming connections from a listener
func (ca *ConnectionAcceptor) AcceptConnections(listener net.Listener, connectionHandler interfaces.ConnectionHandlerInterface) error {
...
func (ca *ConnectionAcceptor) StartAcceptingConnections(listener net.Listener, connectionHandler interfaces.ConnectionHandlerInterface) {
	go func() {
...
func (ca *ConnectionAcceptor) StopAcceptingConnections() {
	ca.mu.Lock()
	defer ca.mu.Unlock()
	ca.stopped = true
}
...
func (ca *ConnectionAcceptor) GetConnectionCount() int {
