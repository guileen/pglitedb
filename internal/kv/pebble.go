...
func (p *PebbleKV) Set(ctx context.Context, key, value []byte) error {
	return p.SetWithOptions(ctx, key, value, DefaultWriteOptions)
}

func (p *PebbleKV) SetWithOptions(ctx context.Context, key, value []byte, opts *WriteOptions) error {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
func (p *PebbleKV) Delete(ctx context.Context, key []byte) error {
	return p.DeleteWithOptions(ctx, key, DefaultWriteOptions)
}

func (p *PebbleKV) DeleteWithOptions(ctx context.Context, key []byte, opts *WriteOptions) error {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
func (p *PebbleKV) CommitBatch(ctx context.Context, batch Batch) error {
	return p.CommitBatchWithOptions(ctx, batch, DefaultWriteOptions)
}

func (p *PebbleKV) CommitBatchWithOptions(ctx context.Context, batch Batch, opts *WriteOptions) error {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
func (p *PebbleKV) NewIterator(opts *IteratorOptions) Iterator {
...
func (p *PebbleKV) NewSnapshot() (Snapshot, error) {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
func (p *PebbleKV) NewTransaction(ctx context.Context) (Transaction, error) {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
func (p *PebbleKV) CheckForConflicts(txn Transaction, key []byte) error {
	p.mu.RLock()
	defer p.mu.RUnlock()
...
func (s *PebbleSnapshot) NewIterator(opts *IteratorOptions) Iterator {
	var pebbleOpts *pebble.IterOptions
	if opts != nil {
		pebbleOpts = &pebble.IterOptions{
			LowerBound: opts.LowerBound,
...
func (t *PebbleTransaction) NewIterator(opts *IteratorOptions) Iterator {
	var pebbleOpts *pebble.IterOptions
	if opts != nil {
		pebbleOpts = &pebble.IterOptions{
			LowerBound: opts.LowerBound,
...
func (t *PebbleTransaction) Isolation() IsolationLevel {
	t.mu.RLock()
	defer t.mu.RUnlock()
	return t.isolation
}

func (t *PebbleTransaction) SetIsolation(level IsolationLevel) error {
	t.mu.Lock()
	defer t.mu.Unlock()
	...
	switch level {
	case ReadUncommitted, ReadCommitted, RepeatableRead, SnapshotIsolation, Serializable:
		t.isolation = level
		return nil
	default:
